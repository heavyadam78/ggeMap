const CONFIG = {
    ...
    images: {
        castle: "./img/iconcastle.png",
        iconcastle: "./img/iconcastle.png",
        outpost: "./img/iconoutpost.png",
        iconoutpost: "./img/iconoutpost.png",
        ruin: "./img/iconruins.png",
        iconruin: "./img/iconruins.png",
        lab: "./img/iconlabolatorium.png",
        iconlab: "./img/iconlabolatorium.png",
        monument: "./img/iconmonument.png",
        iconmonument: "./img/iconmonument.png",
        village: "./img/iconvillage.png",
